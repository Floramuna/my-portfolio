...
function Calendar({ className, classNames, showOutsideDays = true, ...props }) {
    return (<react_day_picker_1.DayPicker showOutsideDays={showOutsideDays} className={(0, utils_1.cn)("p-3", className)} classNames={{
            ...
            IconLeft: ({ className, ...props }) => (<lucide_react_1.ChevronLeft className={(0, utils_1.cn)("size-4", className)} {...props}/>),
            IconRight: ({ className, ...props }) => (<lucide_react_1.ChevronRight className={(0, utils_1.cn)("size-4", className)} {...props}/>),
        }} {...props}/>);
}
