        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="md:w-3/5 animate-fade-in">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a 
                href="/florence-makaa-cv.pdf" 
                download
                className="px-6 py-3 border-2 border-purple-500 text-purple-700 rounded-md hover:bg-purple-50 transition-colors flex items-center font-medium"
              >
                Download CV
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="flex flex-col items-center p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow bg-white stagger-item group hover:border-purple-200 border border-transparent">
            ...
            <div>
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div key={index} className="relative pl-10 pb-8 border-l-2 border-purple-300 last:border-0 last:pb-0 stagger-item">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-all stagger-item">
