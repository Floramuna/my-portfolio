  ...
  return (
    <Layout>
      ...
      <motion.section
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="pt-20 pb-12 bg-gradient-to-b from-indigo-50 to-purple-50"
      >
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <motion.div
              ...
              className="bg-white rounded-xl shadow-lg p-8 border border-purple-100 flex flex-col"
            >
            ...
            >
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a 
                    href="https://www.linkedin.com/in/florence-makaa"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 rounded-full bg-purple-100 hover:bg-purple-600 text-purple-600 hover:text-white flex items-center justify-center transition-colors"
                    aria-label="LinkedIn"
                  >
                  ...
                  <a
                    href="https://github.com/Floramuna"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 rounded-full bg-purple-100 hover:bg-purple-600 text-purple-600 hover:text-white flex items-center justify-center transition-colors"
                    aria-label="GitHub"
                  ...
                  <a
                    href="https://twitter.com/_florencemakaa"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 rounded-full bg-purple-100 hover:bg-purple-600 text-purple-600 hover:text-white flex items-center justify-center transition-colors"
                    aria-label="Twitter"
      ...
      <section className="py-16 bg-purple-50">
        <div className="container mx-auto px-4">
          ...
          <div className="h-96 bg-gray-200 rounded-xl overflow-hidden shadow-lg max-w-6xl mx-auto">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.808477395489!2d36.82115931475398!3d-1.2863596359792524!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f10d664f5f9e7%3A0x7e3b2d7a3a5b6c1d!2sNairobi%2C%20Kenya!5e0!3m2!1sen!2sus!4v1620000000000!5m2!1sen!2sus"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
